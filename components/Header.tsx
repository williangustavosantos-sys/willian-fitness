...
const copy = {
  it: { links: [["Soluzioni", "/#soluzioni"], ["Programmi", "/#programmi"], ["Come funziona", "/#come-funziona"], ["Willian", "/#willian"], ["Milano", "/#milano"]], cta: "Parla con Willian", open: "Apri menu", close: "Chiudi menu" },
  en: { links: [["Solutions", "/#soluzioni"], ["Programs", "/#programmi"], ["How it works", "/#come-funziona"], ["Willian", "/#willian"], ["Milan", "/#milano"]], cta: "Talk to Willian", open: "Open menu", close: "Close menu" },
  pt: { links: [["Soluções", "/#soluzioni"], ["Programas", "/#programmi"], ["Como funciona", "/#come-funziona"], ["Willian", "/#willian"], ["Milão", "/#milano"]], cta: "Falar com Willian", open: "Abrir menu", close: "Fechar menu" },
} as const;
